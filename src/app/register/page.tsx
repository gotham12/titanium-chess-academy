          ...
          <FadeIn>
            <SpotlightCard className="h-fit p-8">
              ...
              <ol className="mt-8 space-y-6 text-xl text-chrome">
                <li><span className="font-bold text-foreground">1.</span> Submit the form →</li>
                <li><span className="font-bold text-foreground">2.</span> Pick your schedule</li>
                <li><span className="font-bold text-foreground">3.</span> We confirm by email</li>
              </ol>
